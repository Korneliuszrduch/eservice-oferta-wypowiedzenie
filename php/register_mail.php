...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $placeOfAcquiringTheCustomer = isset($_POST['placeOfAcquiringTheCustomer']) ? trim($_POST['placeOfAcquiringTheCustomer']) : '';
        ...
        if ($update === 'true' && isset($_SESSION['sid'])) {
            ...
            if ($stmt->num_rows > 0) {
                ...
                if ($stmt->execute()) {
                    ...
                    // Zapisanie miejsca pozyskania klienta (fid 86)
                    if (!empty($placeOfAcquiringTheCustomer)) {
